...
export default function CreateCampaignPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await AdminApiService.createCampaign(formDataObj)
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Create a comprehensive campaign with detailed content sections
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-1 space-y-6">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    Essential campaign details and settings
                  </p>
                </div>
              ...
              <div className="lg:col-span-2 space-y-6">
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    Detailed content for campaign presentation
                  </p>
                </div>
                    ...
                    {content.impactNumbers.map((stat, index) => (
                      <div key={index} className="flex gap-2 items-start">
                        <input
                          ...
                          className="w-24 border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm"
                          placeholder="e.g. 500+"
                        />
                        <input
                          type="text"
